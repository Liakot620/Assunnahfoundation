...
<section class="flex-container" id="main">
    <div class="container pt-4 pb-4" >
            <div class="row">
                ...
                <div class="col-12">
                    <div class="bg-white pt-4 pb-4" id="about-border" >
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 pb-4">
                                    <div class="embed-responsive embed-responsive-21by9">
                                        <iframe width="380" height="250" src="https://www.youtube.com/embed/NIiy1y0S6zc?si=fFj87cdx6Ce5ONwo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>    
                                        <h6 class="text-center"> Qurbani for All 2021</h6>
                                   </div>
                                 </div> 

                                <div class="col-4 pb-4">
                                    <div class="embed-responsive embed-responsive-21by9">
                                        <iframe width="380" height="250" src="https://www.youtube.com/embed/l1EssrLxt7E?si=KUoknUm5o_8TRbOa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                        <h6 class="text-center"> Tree Planting Program 2021 Illustrated Report</h6>
                                      </div>
                                 </div> 
                                ...
                                <div class="col-4 pb-4">
                                    <div class="embed-responsive embed-responsive-21by9">
                                        <iframe width="380" height="250" src="https://www.youtube.com/embed/l1EssrLxt7E?si=KUoknUm5o_8TRbOa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                        <h6 class="text-center">Self-reliance(Swanirvor) project 2020-21 organized by As-Sunnah Foundation </h6>
                                      </div>
                                 </div> 
                                ...
                                <div class="col-4 pb-4">
                                    <div class="embed-responsive embed-responsive-21by9">
                                        <iframe width="380" height="250" src="https://www.youtube.com/embed/l1EssrLxt7E?si=KUoknUm5o_8TRbOa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                        <h6 class="text-center"> As-Sunnah Foundation's Qurbani on behalf of the affluents report 2020</h6>
                                      </div>
                                 </div> 
                                ...
                                <div class="col-4 pb-4">
                                    <div class="embed-responsive embed-responsive-21by9">
                                      ...
                                      <h6 class="text-center">Winter clothing distribution report 2020 </h6>
                                 </div> 
                                ...
                                <div class="col-4 pb-4">
                                    <div class="embed-responsive embed-responsive-21by9">
                                      ...
                                      <h6 class="text-center"> First time half lakhs winter clothes distribution</h6>
                                 </div> 
