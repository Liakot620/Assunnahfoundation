            ...
            <div class="row">
                <div class="col-4">
                    <div class="about-link p-4">
                        <ul>
                            <li> <a href="#" class="active1"> Post Graduate Diploma in Islamic Da'wah </a> </li>
                            <li> <a href="#"> Quran Year </a> </li>
                            <li> <a href="#"> Smart Tailoring and Fashion Design training </a> </li>
                            <li> <a href="#"> Small Business Management Course </a> </li>
                ...
                <div class="col-8 ">
                    <div class="bg-white p-4" id="about-border" >
                        <h4 class="text-success">Post Graduate Diploma in Islamic Da'wah</h4>
                        <p class=" pt-3">This is an educational initiative of As-Sunnah Foundation's 'As-Sunnah Da'wah and Research Institute'. The main objective of this initiative is to produce Da'ees suitable for work at national and international levels. </p>
                    </div>
                </div>
            </div>
     </div>
