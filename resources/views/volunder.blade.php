                                    ...
                                    <div class="gallery mt-3 mb-3">
                                      <form>
                                        <div class="row g-3">
                                          ...
                                          <p class="text-center text-danger"> * Marked fields is mandatory, others are optional <p>
                                          <div class="col-12">
                                            <div class="row">
                                              <div class="col-md-12">
                                                <button type="submit" class="btn btn-success w-100 fw-bold " >Send My Application</button>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
