...
<section class="flex-container bg-success pt-3 pb-3" id="main">
...
<section class="flex-container" id="main">
    <div class="container pt-4 pb-4" >
            <div class="row">
                <div class="col-4">
                    <div class="about-link p-4">
                        <ul>
                            <li> <a href="#" class="active1"> Self-reliance Project with Zakat Funds </a> </li>
                            <li> <a href="#">Qurbani (Sacrificing animals) for all</a> </li>
                            <li> <a href="#"> Distribution of relief to flood victims </a> </li>
                            <li> <a href="#"> Raising and educating orphans </a> </li>
                            <li> <a href="#"> Sadaqah (Charity) Jariyah</a> </li>
                            <li> <a href="#"> Distribution of winter clothes</a> </li>
                ...
                <div class="col-8 ">
                    <div class="bg-white p-4" id="about-border" >
                        <h4 class="text-success">Self-reliance Project with Zakat Funds</h4>
                        <p class=" pt-2">One of the teachings of Islam is human service. Every year, the As-Sunnah Foundation organizes a ‘Winter Clothing Distribution and Dawah Program’ to bring a little warmth to the helpless shivering cold-stricken people of remote areas. </p>
                        <p class=" pt-2">One of the teachings of Islam is human service. Every year, the As-Sunnah Foundation organizes a ‘Winter Clothing Distribution and Dawah Program’ to bring a little warmth to the helpless shivering cold-stricken people of remote areas. </p>
                        <p class=" pt-2">One of the teachings of Islam is human service. Every year, the As-Sunnah Foundation organizes a ‘Winter Clothing Distribution and Dawah Program’ to bring a little warmth to the helpless shivering cold-stricken people of remote areas. </p>

                        <h5 class="text-success">The following programs have been implemented under the Self-reliance Project:</h5>

                        <p class=" pt-2">Distribution of rickshaws, vans, cows, goats, grocery items, fishing nets, boats, etc., to economically disadvantaged individuals in 64 districts, benefiting 3,077 people. In 2023, 2,000 rickshaws have already been distributed. </p>
                    </div>
                </div>
            </div>
     </div>
