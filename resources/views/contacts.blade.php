    ...
    <div class="container pt-4 pb-4" >
            <div class="row">
                <div class="col-6">
                  ...
                  <div class="col-12">
                    <div class="bg-white p-2 " id="about-border" >
                        <div class="container">
                                      ...
                                      <form>
                                        <div class="row g-3">
                                          ...
                                          <div class="col-12">
                                            <div class="row">
                                              <div class="col-md-6">
                                                <button type="submit" class="btn btn-success w-100 fw-bold " >Send</button>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                              ...
                              <div class="container">
                                  ...
                                  <div class="row">
                                      <div class="col-6">
                                          <div class="gallery mt-3 mb-3">
                                            <h4> Where are we?</h4>
                                            <iframe style="width:590px;height:400px;"
                                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.8354345093576!2d144.95592811531563!3d-37.81720997975171!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d5df1f0df2b%3A0x5045675218cee17!2sMelbourne%20VIC%2C%20Australia!5e0!3m2!1sen!2sus!4v1614313214471!5m2!1sen!2sus" 
                                                allowfullscreen="" 
                                                loading="lazy">
                                            </iframe>
                                            </div>
                                  ...
                                  <div class="row">
                                      <div class="col-12">
                                          <div class="gallery mt-3 mb-3">
                                            ...
                                            <h5> Address</h5>
                                          <p> As-Sunnah Foundation <br>
                                            Plot-70, Road-3, Block-C, (Opposite Siraj Convention Center)<br>
